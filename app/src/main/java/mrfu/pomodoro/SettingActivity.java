...
public class SettingActivity extends PreferenceActivity implements OnSharedPreferenceChangeListener {
    ...
    private void alertDialogShow() {
        new AlertDialog.Builder(SettingActivity.this).setTitle("清除？").setMessage("是否清除计数？\n注：该操作不可逆！").setPositiveButton("清除", new DialogInterface.OnClickListener() {

            @Override
            public void onClick(DialogInterface dialog, int which) {
                SharedPreferences mySharedPreferences = SettingActivity.this.getSharedPreferences("TomatoCount",
        ...
        switch (requestCode) {
            case 1:{
                ...
                if(null == pickedUri){
                    ...
                    String strRingtone = ringtone.getTitle(SettingActivity.this);
