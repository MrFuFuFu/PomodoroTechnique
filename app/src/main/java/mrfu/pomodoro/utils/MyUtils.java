...
public class MyUtils {
	...
	public final static String MY_PACKAGE_NAME = "mrfu.pomodoro";
...
//		}
	...
	public static Boolean isMobileDataEnabled(Context paramContext){
	    Object connectivityService = paramContext.getSystemService(Context.CONNECTIVITY_SERVICE);
...
//			Log.e("isScreenOn:",String.valueOf(isScreenOn));
	...
	public static int getScreenWidth(){
		Activity mActivity = PomodoroApplication.getActivity();
...
//		Activity mActivity = TickerApplication.getActivity();
//		DisplayMetrics dm = new DisplayMetrics();   
//		mActivity.getWindowManager().getDefaultDisplay().getMetrics(dm);
//		return dm.xdpi;
//	}
...
//	        loge("get status bar height fail");
	...
	public static void addContinueTimes(Context c){
		SharedPreferences sp = c.getSharedPreferences("mrfu.pomodoro.ticker_preferences", Context.MODE_PRIVATE);
...
//		     Log.e(e.toString());
	...
	public static String getAppVersion(){
		...
		try {
			pInfo = PomodoroApplication.getActivity().
					getPackageManager().getPackageInfo(
                    PomodoroApplication.getActivity().
							getPackageName(), 0);
	...
	public static boolean isWakeLockServiceRunning() {
        ActivityManager manager = (ActivityManager) PomodoroApplication.getInstance().getSystemService(PomodoroApplication.getInstance().ACTIVITY_SERVICE);
        for (ActivityManager.RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
            if ("mrfu.pomodoro.service.WakeLockService".equals(service.service.getClassName())) {
                Trace.debug("isWakeLockServiceRunning = true");
                return true;
            }
        }
        return false;
